          ...
          <table className="w-full border-collapse min-w-[650px] bg-white rounded-lg overflow-hidden shadow-sm">
            ...
            <tbody>
              ...
              <tr className="bg-white">
                ...
                <td className="p-3 text-center text-black text-base">IATF</td>
                <td className="p-3 text-center text-black text-base">
              ...
              <tr className="bg-[#fafafa]">
                <td className="p-3 text-center text-black text-base">BF003</td>
                <td className="p-3 text-center text-black text-base">
                  Dr. João Lima
                </td>
                <td className="p-3 text-center text-black text-base">
              ...
              <tr className="bg-white">
                <td className="p-3 text-center text-black text-base">BF004</td>
                <td className="p-3 text-center text-black text-base">
                  Dr. Ana Pereira
                </td>
                <td className="p-3 text-center text-black text-base">
